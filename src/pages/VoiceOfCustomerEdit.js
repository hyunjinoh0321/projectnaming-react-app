...
export default function RuleEdit() {
  ...
  useEffect(() => {
    axios.get(`http://172.23.125.110:3030/projectnaming/board/${id}`)
      .then((response) => {
        ...
        setDescription(outputData.description);
        setCreator(outputData.creator);
      })
  ...
  const handleSave = (event) => {
    ...
    axios.put(`http://172.23.125.110:3030/projectnaming/board/${id}`, newVoiceOfCustomer)
      .then((response) => {
  ...
  return (
    <div className="container">
      <h2 className="text-center mt-5 mb-3">고객의소리 수정</h2>
      <div className="card">
